package br.com.dgc.fmtools.formation_calculator_service.domain.model.positions.defender_right_left;
...
public class InvertedWingBackAuDRL extends Position {
  ...
  public InvertedWingBackAuDRL() {
    super(PositionNames.INVERTED_WING_BACK_AU_DRL_NAME);
  }
}
