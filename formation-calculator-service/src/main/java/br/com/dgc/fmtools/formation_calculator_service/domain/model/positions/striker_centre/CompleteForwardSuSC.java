package br.com.dgc.fmtools.formation_calculator_service.domain.model.positions.striker_centre;
...
public class CompleteForwardSuSC extends Position {
  ...
  public CompleteForwardSuSC() {
    super(PositionNames.COMPLETE_FORWARD_SU_SC_NAME);
  }
}
