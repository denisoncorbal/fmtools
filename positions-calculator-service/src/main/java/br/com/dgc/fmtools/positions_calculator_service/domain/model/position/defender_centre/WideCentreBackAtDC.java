...
public class WideCentreBackAtDC extends Position {

  public WideCentreBackAtDC(LinePlayer player) {
    super(
        PositionNames.WIDE_CENTRE_BACK_AT_DC_NAME,
        List.of(
            ...
            player.getPositioning() * DefenderCentreWeights.POSITIONING,
        ...
        List.of(
            ...
            player.getOffTheBall() * DefenderCentreWeights.OFF_THE_BALL * 2,
        ...
        List.of(
                ...
                DefenderCentreWeights.POSITIONING,
                ...
                DefenderCentreWeights.OFF_THE_BALL * 2,
