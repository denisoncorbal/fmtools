...
public interface AttackingMidfielderCentrePositions {
  default LinePlayer applyAttributeWeight(LinePlayer initPlayer) {
    ...
    player.setFinishing(player.getFinishing() * 3);
    player.setFirstTouch(player.getFirstTouch() * 5);
    ...
    player.setTechnique(player.getTechnique() * 5);
    ...
    player.setDecisions(player.getDecisions() * 6);
    ...
    player.setAcceleration(player.getAcceleration() * 9);
