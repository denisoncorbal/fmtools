...
public class SquadManagerClientService {
  ...
  @CircuitBreaker(name = "squad-manager-service")
  @Retry(name = "squad-manager-service", fallbackMethod = "getGoalkeeperPlayerByIdFallback")
  ...
  @CircuitBreaker(name = "squad-manager-service")
  @Retry(name = "squad-manager-service", fallbackMethod = "getLinePlayerByIdFallback")
